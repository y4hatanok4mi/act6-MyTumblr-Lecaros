...
//check if the session variables are set/existing
//to check if the account is logged in
...
body {
    background: #654ea3;
    background: linear-gradient(to right, #4E98D4, #1B3661);
    min-height: 100vh;
    overflow-x: hidden
}</style>
                                </head>
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">85,435,795</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Followers</small>
                    </li>
                    <li class="list-inline-item">
