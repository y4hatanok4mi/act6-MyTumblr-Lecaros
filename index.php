...
$acc_username = "LecarosJC";
$acc_password = "johncarllecaros";
$acc_fullname = "John Carl Lecaros";
$acc_address = "Ino, Mogpog, Marinduque PH";
...
if(isset($_REQUEST['login_button']) === true){
	//get and compare the username and password from the form to the pre-defined username and password
		//if username does not exist
		if($_REQUEST['form_username'] != $acc_username){
			header("Location: ".$url_add."?notexist");
		}
		//if username is found but password is wrong
